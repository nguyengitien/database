...
-- username sõ giõng email nhung bò phän @..mail di
     SELECT SUBSTRING_INDEX(in_email,"@",1) INTO v_username;
-- position id sõ có default là developen
     SELECT position_id INTO v_position_id
     FROM position
     WHERE position_name = "Dev";
-- department_id së dugc cho vào 1 phòng chờ 
...
CALL sp_07("Nguyễn Văn A","nguyenvana@gmail.com");
...
DELIMITER $$
CREATE PROCEDURE sp_13 ( IN in_department_id INT)
BEGIN
